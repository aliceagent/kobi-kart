...
// Each note is [name|null(rest), beats]. Melody & bass loops total 8 beats so
// they stay locked; the drum tiles a 2-beat pattern.
const TRACKS = {
  ...
  Grassy: {
    ...
    bass: [['C3', 1], ['C3', 1], ['G2', 1], ['G2', 1], ['C3', 1], ['C3', 1], ['G2', 1], ['G2', 1]],
    drum: [['k', 1], ['s', 1]],
  },
  ...
  Menu: {
    ...
    bass: rep([['C3', 1], ['G3', 1], ['F3', 1], ['G3', 1]], 2),
    drum: [['k', 2]],
  },
};
